...
CSV_FILES = {
    ...
    "simd c++": "simd_c_timing_results_2026-05-30_22-54-00.csv",
}
...
impl  = dfs["python code"]["implementation"].iloc[0]
batch = int(dfs["python code"]["batch"].iloc[0])

N_values = dfs["python code"]["channels"].values  # channels = BASE_C*N = N
...
# Axes labels & title
ax.set_title(
    f"Optimized c++, Vectorized c++ and Python code timing Comparison (batch size {batch})",
...
# Save
OUT = "timing_comparison_py_opt_sim.png"
plt.tight_layout()

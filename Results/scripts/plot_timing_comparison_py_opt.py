...
impl  = dfs["optimized c++"]["implementation"].iloc[0]
batch = int(dfs["optimized c++"]["batch"].iloc[0])
...
# Axes labels & title
ax.set_title(
    f"Baseline c++ — and python code timing Comparison (batch size {batch})",
...
# Save
OUT = "timing_comparison_py_opt.png"
plt.tight_layout()

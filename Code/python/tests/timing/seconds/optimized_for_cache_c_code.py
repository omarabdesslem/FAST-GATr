...
OUTPUT_FILE = RESULTS_DIR / f"optimized_for_cache_c_timing_results_{DATE_TIME}.csv"
CPP_IMPL = "optimized_for_cache"
...
IMPLEMENTATION_NAME = "Optimized-for-cache C++"
...
def benchmark_optimized_for_cache_cpp():
    os.chdir(CODE_DIR)

    print("\033[35m========================================\033[0m")
    print("\033[35m  Optimized-for-cache C++ Timing Benchmark [ms]\033[0m")
    print("\033[35m========================================\033[0m\n")
    ...
    print("\n\033[32m========================================\033[0m")
    print("\033[32m  Optimized-for-cache C++ timing benchmark completed\033[0m")
    print("\033[32m========================================\033[0m")


if __name__ == "__main__":
    benchmark_optimized_for_cache_cpp()

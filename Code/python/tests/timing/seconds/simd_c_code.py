...
CPP_IMPL = os.environ.get("CPP_IMPL", "simd").strip().lower()
OUTPUT_FILE = RESULTS_DIR / f"{CPP_IMPL}_c_timing_results_{DATE_TIME}.csv"

WARMUP = 10
RUNS = 30
SEED = 42

IMPLEMENTATION_NAME = f"{CPP_IMPL} C++"
...
def benchmark_simd_cpp():
    os.chdir(CODE_DIR)

    print("\033[35m========================================\033[0m")
    print("\033[35m  SIMD C++ Timing Benchmark [ms]\033[0m")
    print("\033[35m========================================\033[0m\n")
    ...
    print("\n\033[32m========================================\033[0m")
    print("\033[32m  SIMD C++ timing benchmark completed\033[0m")

...
os.environ["BASIS_PATH"] = str(CODE_DIR / "basis")
os.chdir(CODE_DIR)
...
OUTPUT_FILE = RESULTS_DIR / f"c_timing_results_{DATE_TIME}.csv"
CPP_IMPL = "baseline"
...
def benchmark_cpp():
    ...
    print("\033[35m  C++ Timing Benchmark [ms]\033[0m")
    print("\033[35m========================================\033[0m\n")
    ...
    print("\n\033[32m========================================\033[0m")
    print("\033[32m  C++ timing benchmark completed\033[0m")

...
TEST_NAME = "equi_join_validation"
...
from ezgatr.nn.functional import equi_join as equi_join_pytorch
from ops.dual import equi_join as equi_join_asl
...
def test_equi_join():
    ...
    print("\033[35m  EzGATr equi_join Validation Test\033[0m")
    print("\033[35m========================================\033[0m\n")
    ...
    print("\033[36m[INFO]\033[0m Comparing Python equi_join with optimized-for-cache ASL/C++ equi_join\n")
    ...
    for batch, tokens, channels in test_cases:
        ...
        reference = torch.randn(batch, 1, 1, 16)

        with torch.no_grad():
            expected = equi_join_pytorch(x, y, reference)
            result = equi_join_asl(x, y, reference)
    ...
    if all_passed:
        print("\n\033[32m========================================\033[0m")
        print("\033[32m  equi_join validation completed successfully\033[0m")
        print("\033[32m========================================\033[0m")
    else:
        print("\n\033[31m========================================\033[0m")
        print("\033[31m  equi_join validation failed\033[0m")

...
def test_geometric_product():
    ...
    print("\033[35m  EzGATr geometric_product Validation Test\033[0m")
    print("\033[35m========================================\033[0m\n")
    ...
    print("\033[36m[INFO]\033[0m Comparing Python geometric_product with optimized-for-cache ASL/C++ geometric_product\n")

...
def test_attention():
    ...
    print("\033[35m  EzGATr equi_geometric_attention Validation (SIMD)\033[0m")
    print("\033[35m========================================\033[0m\n")
    ...
    print("\033[36m[INFO]\033[0m Comparing Python equi_geometric_attention with vectorized ASL/C++ version\n")
